...
## フロントエンドの技術選定は会社の命運を左右する --- importance-of-technology-choice

極論ではなく、フロントエンドの技術選定は会社の命運を左右することがあります。[フロントエンド技術のリプレイスには膨大な工数がかかる](https://zenn.dev/naofumik/articles/48cee8d06788bd)ことがあり、5年経っても終わらないというケースも珍しくないからです。これだけ開発リソースを食いつぶしながらUI/UXが特に良くなるわけでもないので、当然ながら会社の業績に大きな影響が出ます。

それだけに流行や話題性ではなく、メリットを具体的にし、かつ開発工数を早めに把握することが極めて大切になります。このページではそのための視点の紹介および情報提供をしています。

## そもそもReactとERB/Hotwireは共存できる --- coexistence-of-react-and-hotwire

そもそものReactを選択するか、それおもHotwireを選択するかという論点自体に課題があります。二者択一ではありません。[ERB/Hotwireのページの中にReactを埋め込んで共存させられる](/other_libraries/using_with_react)からです。
