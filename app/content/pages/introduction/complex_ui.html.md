...
* FigmaはReactを使っていますが、メニューやボタンなどで使っているのみです。実際に図を並べでデザインするところは[Canvas](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/canvas)です。Figmaの「複雑なUI/UX」は主にCanvasです。
